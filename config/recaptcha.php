...
return [
     ...
     *
     */
    'api_site_key' => env('RECAPTCHA_SITE_KEY', '__# Enter The Site Key #__'),
     ...
     *
     */
    'api_secret_key' => env('RECAPTCHA_SECRET_KEY', '__# Enter The Secret Key #__'),
     ...
     *
     */
    'default_form_id' => 'invisible-recaptcha-form',
