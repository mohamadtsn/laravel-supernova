{{-- Header --}}
@if (config('supernova.layout.extras.notifications.dropdown.style') == 'light')
...
@else
    <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url('{{ asset('panel/media/misc/bg-1.jpg') }}')">
        {{-- Title --}}
