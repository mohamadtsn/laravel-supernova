                    ...
                    <div class="d-flex align-items-start mt-n2">
                        ...
                        <a href="#" class="symbol symbol-35 symbol-light-success mr-2">
                            <span class="symbol-label">
                                <img src="{{ asset('panel/media/svg/avatars/004-boy-1.svg') }}" class="h-75 align-self-end"/>
                            </span>
                        </a>
                        ...
                        <a href="#" class="symbol symbol-35 symbol-light-success">
                            <span class="symbol-label">
                                <img src="{{ asset('panel/media/svg/avatars/002-girl.svg') }}" class="h-75 align-self-end"/>
                            </span>
                        </a>
                    </div>
                </div>
